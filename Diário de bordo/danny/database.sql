...
('Administrador Principal', 'admin@example.com', '(19) 99999-9999', '$2y$12$VRA5Ae/gY/i5sLUQVyb7IeYz3KV6lI5e/QTo/VHAw90.mi9/SJVAm', 0, 'ADMIN');

INSERT INTO fotografos (`nome`, `telefone`, `email`) VALUES
('Dany Cardozo', '(19) 99999-9999', 'contato@example.com');
