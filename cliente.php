  ...
  <div class="admin-shell">
    ...
    <main class="admin-main">
      ...
      <?php if (isset($_GET['agendamento']) && $_GET['agendamento'] === 'sucesso'): ?>
        <div class="client-feedback client-feedback--success">Sua solicitação foi enviada! Agora ela aguarda a confirmação do administrador.</div>
      <?php endif; ?>
      ...
      <?php if (isset($_GET['cancelamento']) && $_GET['cancelamento'] === 'sucesso'): ?>
        <div class="client-feedback client-feedback--success">Sua solicitação foi cancelada com sucesso.</div>
      <?php endif; ?>
        ...
        <div class="client-feedback client-feedback--error">
          <?php
            echo match ($_GET['erro']) {
              ...
              'servico' => 'O serviço selecionado não combina com seu interesse. Verifique os campos de interesse e serviço.',
              'horario_limite' => 'Não foi possível enviar a solicitação. O horário deve estar entre 06:00 e 20:00.',
              ...
              'cenario_nicho' => 'O cenário escolhido não pertence ao mesmo nicho do serviço.',
              ...
              'conflito' => 'Não foi possível enviar a solicitação porque há um conflito de horário.',
              'cancelamento' => 'Não foi possível cancelar esta solicitação. Apenas pedidos pendentes podem ser cancelados.',
